export const dict = {
  ...
  "dialog.provider.Amis.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.Amis.tagline": "Pouzdani optimizovani modeli",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje Amis",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u Amis-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u Amis-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u Amis-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u Amis.json",
  ...
  "dialog.server.description": "Promijeni na koji se Amis server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija Amis-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku Amis timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (Amis.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: Amis još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "Amis uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni Amis server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u Amis-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako Amis izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu Amis-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se Amis pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju Amis-a.",
