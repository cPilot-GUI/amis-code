...
export const dict = {
  ...
  "dialog.provider.Amis.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.Amis.tagline": "Zuverlässige, optimierte Modelle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von Amis",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Amis zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.opencodeZen.visit.link": "Amis.ai/zen",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in Amis zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in Amis zu nutzen.",
  ...
  "dialog.plugins.empty": "In Amis.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den Amis-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von Amis ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem Amis-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (Amis.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: Amis unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "Amis enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "settings.desktop.wsl.description": "Amis-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für Amis ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie Amis auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von Amis anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von Amis automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von Amis.",
