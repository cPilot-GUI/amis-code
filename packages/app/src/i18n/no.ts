...
export const dict = {
  ...
  "dialog.provider.Amis.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.Amis.tagline": "Pålitelige, optimaliserte modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av Amis",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn din {{provider}} API-nøkkel for å koble til kontoen din og bruke {{provider}}-modeller i Amis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i Amis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i Amis.",
  ...
  "dialog.plugins.empty": "Plugins konfigurert i Amis.json",
  ...
  "dialog.server.description": "Bytt hvilken Amis-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av Amis ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til Amis-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (Amis.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at Amis ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "Amis inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør Amis-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for Amis",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan Amis ser ut på enheten din",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass hvordan Amis er tematisert.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når Amis starter",
  ...
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av Amis.",
