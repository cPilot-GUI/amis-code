export const dict = {
  ...
  "dialog.provider.Amis.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.Amis.tagline": "Modèles optimisés et fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par Amis",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans Amis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans Amis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans Amis.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans Amis.json",
  ...
  "dialog.server.description": "Changez le serveur Amis auquel cette application se connecte.",
  ...
  "toast.update.description":
    "Une nouvelle version d'Amis ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe Amis",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (Amis.json) pour les noms de fournisseur/modèle",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'Amis ne supporte pas encore l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "Amis inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur Amis dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour Amis",
  "settings.general.row.appearance.title": "Apparence",
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'Amis sur votre appareil",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'Amis.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'Amis",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'Amis.",
