export const dict = {
  ...
  "dialog.provider.Amis.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.Amis.tagline": "Modelos otimizados e confiáveis",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo Amis",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no Amis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no Amis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no Amis.",
  ...
  "dialog.plugins.empty": "Plugins configurados em Amis.json",
  ...
  "dialog.server.description": "Trocar para qual servidor Amis este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do Amis ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do Amis",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (Amis.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: Amis ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "Amis inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor Amis dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do Amis",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o Amis aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o Amis é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o Amis iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do Amis.",
