export const dict = {
  ...
  "dialog.provider.Amis.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.Amis.tagline": "Niezawodne, zoptymalizowane modele",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez Amis",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w Amis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów kodujących.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w Amis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w Amis.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w Amis.json",
  ...
  "dialog.server.description": "Przełącz serwer Amis, z którym łączy się ta aplikacja.",
  ...
  "toast.update.description": "Nowa wersja Amis ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu Amis",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (Amis.json) nazwy dostawców/modeli",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, Amis does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "Amis zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Run the Amis server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla Amis",
  "settings.general.row.appearance.title": "Wygląd",
  "settings.general.row.appearance.description": "Dostosuj wygląd Amis na swoim urządzeniu",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw Amis.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania Amis",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji Amis.",
