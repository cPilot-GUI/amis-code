export const dict = {
  ...
  "dialog.provider.Amis.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.Amis.tagline": "Pålidelige optimerede modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af Amis",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i Amis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i Amis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i Amis.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i Amis.json",
  ...
  "dialog.server.description": "Skift hvilken Amis-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af Amis ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til Amis-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (Amis.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, Amis understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "Amis inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør Amis-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for Amis",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan Amis ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan Amis er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når Amis starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af Amis.",
