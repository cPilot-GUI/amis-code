export const dict = {
  ...
  "dialog.provider.Amis.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.Amis.tagline": "Modelos optimizados y fiables",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por Amis",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en Amis.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en Amis.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en Amis.",
  ...
  "dialog.plugins.empty": "Plugins configurados en Amis.json",
  ...
  "dialog.server.description": "Cambiar a qué servidor de Amis se conecta esta app.",
  ...
  "toast.update.description": "Una nueva versión de Amis ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Por favor reporta este error al equipo de Amis",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (Amis.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota, Amis no soporta autenticación MCP todavía.',
  ...
  "sidebar.gettingStarted.line1": "Amis incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor Amis dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para Amis",
  "settings.general.row.appearance.title": "Apariencia",
  "settings.general.row.appearance.description": "Personaliza cómo se ve Amis en tu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de Amis.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia Amis",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de Amis.",
