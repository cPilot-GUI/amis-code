...
export const dict = {
  ...
  "dialog.provider.Amis.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.Amis.tagline": "Güvenilir optimize edilmiş modeller",
  ...
  "dialog.model.unpaid.freeModels.title": "Amis tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve Amis'da {{provider}} modellerini kullanmak için {{provider}} API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "Amis Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.prefix":
    "Hesabınızı bağlamak ve Amis'da {{provider}} modellerini kullanmak için ",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak Amis'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler Amis.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi Amis sunucusuna bağlanacağını değiştirin.",
  ...
  "toast.update.description": "Amis'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı Amis ekibine bildirin",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızı (Amis.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" başarısız oldu. Not: Amis henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "Amis ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "Amis Masaüstü",
  ...
  "settings.desktop.wsl.description": "Amis sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "Amis'un görünüm dilini değiştirin",
  "settings.general.row.appearance.title": "Görünüm",
  "settings.general.row.appearance.description": "Amis'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Amis'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "Amis başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "Amis'un en son sürümünü kullanıyorsunuz.",
