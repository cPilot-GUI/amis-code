export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの Amis を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "Amis のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'Amis' コマンドを使用してください。",
  ...
  "desktop.menu.help.documentation": "Amis ドキュメント",
  ...
  "desktop.cli.error.sidecarMissing":
    "Amis CLI のバイナリが見つかりません。デスクトップアプリを再インストールしてみてください。",
