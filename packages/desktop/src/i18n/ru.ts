export const dict = {
  ...
  "desktop.updater.none.message": "Вы уже используете последнюю версию Amis",
  ...
  "desktop.updater.downloaded.prompt": "Версия Amis {{version}} загружена. Хотите установить и перезапустить?",
  ...
  "desktop.cli.installed.message":
    "CLI установлен в {{path}}\n\nПерезапустите терминал, чтобы использовать команду 'Amis'.",
  ...
  "desktop.menu.help.documentation": "Документация Amis",
  ...
  "desktop.cli.error.sidecarMissing":
    "Отсутствует бинарный файл Amis CLI. Попробуйте переустановить настольное приложение.",
