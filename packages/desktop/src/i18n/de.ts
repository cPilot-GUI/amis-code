export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von Amis wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
  ...
  "desktop.cli.installed.message":
    "CLI wurde in {{path}} installiert\n\nStarten Sie Ihr Terminal neu, um den Befehl 'Amis' zu verwenden.",
  ...
  "desktop.menu.help.documentation": "Amis-Dokumentation",
  ...
  "desktop.cli.error.sidecarMissing":
    "Das Amis CLI-Binary fehlt. Versuchen Sie, die Desktop-App neu zu installieren.",
