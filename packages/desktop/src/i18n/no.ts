export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av Amis er lastet ned. Vil du installere den og starte på nytt?",
  ...
  "desktop.menu.help.documentation": "Amis Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Amis CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
