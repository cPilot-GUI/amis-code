export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af Amis er blevet downloadet. Vil du installere den og genstarte?",
  ...
  "desktop.cli.installed.message":
    "CLI installeret i {{path}}\n\nGenstart din terminal for at bruge 'Amis'-kommandoen.",
  ...
  "desktop.cli.error.sidecarMissing": "Amis CLI-binærfil mangler. Prøv at geninstallere desktop-appen.",
