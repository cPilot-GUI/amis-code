export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من Amis",
  ...
  "desktop.updater.downloaded.prompt": "تم تنزيل إصدار {{version}} من Amis، هل ترغب في تثبيته وإعادة تشغيله؟",
  ...
  "desktop.menu.help.documentation": "وثائق Amis",
  ...
  "desktop.cli.error.sidecarMissing": "ملف Amis CLI الثنائي مفقود. حاول إعادة تثبيت تطبيق سطح المكتب.",
