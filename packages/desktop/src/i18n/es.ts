export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Amis. ¿Quieres instalarla y reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentación de Amis",
  ...
  "desktop.cli.error.sidecarMissing":
    "Falta el binario de la CLI de Amis. Intenta reinstalar la aplicación de escritorio.",
