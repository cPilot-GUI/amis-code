export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do Amis foi baixada. Você gostaria de instalá-la e reiniciar?",
  ...
  "desktop.menu.help.documentation": "Documentação do Amis",
  ...
  "desktop.cli.error.sidecarMissing":
    "O binário da CLI do Amis está ausente. Tente reinstalar o aplicativo de desktop.",
