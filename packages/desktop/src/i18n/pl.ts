export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} Amis. Czy chcesz ją zainstalować i uruchomić ponownie?",
  ...
  "desktop.cli.installed.message":
    "CLI zainstalowane w {{path}}\n\nUruchom ponownie terminal, aby użyć polecenia 'Amis'.",
  ...
  "desktop.menu.help.documentation": "Dokumentacja Amis",
  ...
  "desktop.cli.error.sidecarMissing":
    "Brakuje pliku binarnego Amis CLI. Spróbuj ponownie zainstalować aplikację na komputer.",
