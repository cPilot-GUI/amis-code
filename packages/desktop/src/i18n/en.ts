export const dict = {
  ...
  "desktop.menu.help.documentation": "Amis Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of Amis has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'Amis' command.",
  ...
  "desktop.cli.error.sidecarMissing": "Amis CLI binary is missing. Try reinstalling the desktop app.",
