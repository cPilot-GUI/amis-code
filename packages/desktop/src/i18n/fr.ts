export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'Amis",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'Amis a été téléchargée. Voulez-vous l'installer et redémarrer ?",
  ...
  "desktop.cli.installed.message":
    "CLI installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'Amis'.",
  ...
  "desktop.menu.help.documentation": "Documentation d'Amis",
  ...
  "desktop.cli.error.sidecarMissing":
    "Le binaire de la CLI Amis est manquant. Essayez de réinstaller l'application de bureau.",
