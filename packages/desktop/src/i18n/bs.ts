export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju Amis-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} Amis-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
  ...
  "desktop.cli.installed.message":
    "CLI je instaliran u {{path}}\n\nRestartuj terminal da bi koristio komandu 'Amis'.",
  ...
  "desktop.menu.help.documentation": "Amis Dokumentacija",
  ...
  "desktop.cli.error.sidecarMissing":
    "Nedostaje binarna datoteka Amis CLI-a. Pokušaj ponovo instalirati desktop aplikaciju.",
