export const dict = {
  ...
  "desktop.updater.none.message": "你已在使用最新版的 Amis",
  ...
  "desktop.updater.downloaded.prompt": "已下載 Amis {{version}} 版本，是否安裝並重新啟動？",
  ...
  "desktop.menu.help.documentation": "Amis 文件",
  ...
  "desktop.cli.error.sidecarMissing": "Amis CLI 執行檔遺失。請嘗試重新安裝桌面應用程式。",
